<div class="flex-1 flex flex-col gap-6 items-center justify-center">
  ...
  <form method="POST"
    ...
    class="grid w-full max-w-6xl lg:grid-cols-2 gap-3">
    @csrf
    <div class="space-y-2">
    ...
    <div class="space-y-2">
      ...
      <div class="relative h-12 lg:h-14 rounded-md">
        ...
        <input name="mass_hour" type="time" id="time"
          class="border-none text-zinc-400 bg-zinc-900 rounded-md h-full w-full px-3 py-2" min="07:00" max="19:00" />
      </div>
    </div>
    ...
    <div class="space-y-2 lg:col-span-2 border-t border-t-zinc-800">
      <button wire:click="toggleModal"
        class="w-full flex gap-2 text-zinc-500 rounded-md px-3 py-3 items-center justify-start" type="button">
    ...
    <button type="submit"
      class="lg:col-span-2 flex items-center justify-center gap-2 font-medium bg-cyan-800 hover:bg-cyan-900 h-12 lg:h-14 rounded-md">
      @if ($isLoading)
