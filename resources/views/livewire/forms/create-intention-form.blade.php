  ...
  <form wire:submit.prevent="registerIntentions" class="grid gap-4 md:grid-cols-2 w-full max-w-4xl">
    ...
    <div class="space-y-2">
      ...
      <div class="flex gap-2 sm:gap-3 items-center">
        <input wire:model="content" placeholder="Exemplo: sétimos dias, aniversários..." class="w-full text-sm sm:text-base lg:text-lg rounded-md outline-none bg-zinc-900 h-12 lg:h-14 px-3 py-2 text-gray-300" id="contents" type="text">
