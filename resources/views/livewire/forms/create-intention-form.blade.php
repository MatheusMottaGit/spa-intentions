    ...
    <div class="bg-black/60 fixed top-0 right-0 left-0 z-50 justify-center items-center w-full h-full flex p-4">
      <div class="relative rounded-lg shadow bg-zinc-900 w-full max-w-lg">
        ...
        <div class="p-4 md:p-5 space-y-4 flex flex-col items-center justify-center">
          <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 text-cyan-500 bg-cyan-100 rounded-lg dark:bg-cyan-900 dark:text-cyan-50">
            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
              <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
            </svg>
          <span class="sr-only">Check icon</span>
        </div>
          <p class="text-base text-center leading-relaxed text-zinc-400">
